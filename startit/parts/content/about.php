                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="about_content_box box-left">
                                ...
                                <div class="about_img_box">
                                    <img src="wp-content/themes/startit/images/about/img1.jpg" alt="img">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="about_content_box box-right">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="about_img_box">
                                            <img src="wp-content/themes/startit/images/about/img2.jpg" alt="img">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="about_img_box">
                                            <img src="wp-content/themes/startit/images/about/img3.jpg" alt="img">
                                        </div>
                                    </div>
                                </div>
                                <div class="about_txt_box">
